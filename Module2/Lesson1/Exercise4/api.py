"""Application Factory Exercise: Modify the application factory example to use 
pydantic-settings for configuration management. Create separate .env files for 
development and production environments and load the appropriate settings based 
on the environment."""
